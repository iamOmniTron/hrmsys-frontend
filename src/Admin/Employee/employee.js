import {
    ...
    ModalFooter,
    ModalBody,
    ModalCloseButton, useDisclosure, useToast, InputGroup, InputLeftAddon, useColorModeValue
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <HStack direction={{base: 'column', sm: 'row'}}
                                    ...
                                    <FormControl>
                                        ...
                                        <Input type="text" placeholder="middlename" value={employee.middlename}
                                               name="middlename"/>
                                    </FormControl>
                                    <FormControl>
                                ...
                                <HStack direction={{base: 'column', sm: 'row'}}
                                    ...
                                    <FormControl>
                                        ...
                                        <Input type="date" placeholder="enter date of appointment" name="doa" value={employee.doa}/>
                                    </FormControl>
                                    <FormControl>
                                ...
                                <HStack direction={{base: 'column', sm: 'row'}}
                                        align={'start'} mt={6}>
                                    <FormControl>
                                        <FormLabel>Password (Leave empty to maintain previous)</FormLabel>
                                    ...
                                    <FormControl>
                                        ...
                                        <Select id='status' placeholder='select employee status' name="status">
                                            ...
                                            <option value={2} selected={employee.status == 2}>Training</option>
                                            <option value={3} selected={employee.status == 3}>On leave</option>
                                            <option value={4} selected={employee.status == 4}>Retired</option>
                                        </Select>
                                    </FormControl>
                                </HStack>
